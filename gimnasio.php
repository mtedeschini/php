...
class Clase{
    ...
    public function imprimirListado(){
        ...
        echo "<tr><th class='table-dark text-center' colspan='2'>Clase: " . $this->nombre . "</th></tr>";
        echo "<tr><th colspan='2'>Entrenador:</th></tr>";
        echo "<tr><th></th><td>" . $this->entrenador->nombre . "</td></tr>";
        echo "<tr><th colspan='2'>Alumnos:</th></tr>";
        foreach($this->aAlumnos as $alumno){
            echo "<tr><th></th><td>" . $alumno->nombre . "</td></tr>";
        };
    }
